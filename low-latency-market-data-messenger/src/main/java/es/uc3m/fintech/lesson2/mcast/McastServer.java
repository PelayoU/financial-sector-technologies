...
public class McastServer {
    ...
    private static void runServer(String multicastAddress, int port, int ratePerSecond)
        ...
        try (DatagramSocket serverSocket = new DatagramSocket()) {
                ...
                while (true) {
                    ...
                    sendMessage(serverSocket, addr, port, sent);
    ...
    private static void sendMessage(
        ...
        final ByteBuffer payload = rndMsg.toBinary();
        ...
        DatagramPacket packet = new DatagramPacket(
                binaryMessage.array(),    // buffer
                binaryMessage.limit(),    //longitud util
                addr,                     // la direccion multicast
                port                      // puerto
        );
