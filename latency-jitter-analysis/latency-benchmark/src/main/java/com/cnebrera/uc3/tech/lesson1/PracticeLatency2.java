...
public class PracticeLatency2
{
    ...
    static final int MAX_EXPECTED_EXECUTIONS_PER_SECOND = 5; //El enunciado pone 50 no 500
    ...
    private static void runCalculations()
    {
        ...
        final ConcurrentHistogram histogram = new ConcurrentHistogram(2);
        final ConcurrentHistogram histogramAc = new ConcurrentHistogram(2);
        ...
        for (int i = 0; i < NUM_THREADS; i ++)
        {
            ...
            final Runner runner = new Runner(syncOpSimulator, histogram, histogramAc);
            runners.add(runner);
        ...
        System.out.println("------ Latencias (no acumuladas) ---------");
        histogram.outputPercentileDistribution(System.out, 1.0); //Como estamos en milisegundos ahora lo dejamos en 1.0

        System.out.println("-------- Latencias Acumuladas ------------");
        histogramAc.outputPercentileDistribution(System.out, 1.0);
    }
    ...
    private static class Runner implements Runnable
    {
        ...
        public void run()
        {
            ...
            for(int i = 0; i < NUM_EXECUTIONS; i++)
            {
                ...
                histogram.recordValue(latencia);

                // TODO Compute accumulated latency and record it
                histogramAcc.recordValue(latencia + delay);
